...
* [X] Used Recycler View Adapter instead of ListView.
* [X] Handled configuration changes.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/eWt8GTg.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />

## Open-source libraries used

- [OkHttp](https://github.com/square/okhttp) - Simple asynchronous HTTP requests.
